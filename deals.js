...
window.DEALS = [
  ...
  /* ============ HONDA CR-V ============ */
  {
    ...
    dealer: "Pickering dealer", city: "Pickering, ON", distanceKm: 28,
  ...
  /* ============ TOYOTA RAV4 ============ */
  {
    id: "rav4-hybrid-xle-blue-used",
    status: "used",
    year: 2025, make: "Toyota", model: "RAV4 Hybrid", trim: "XLE AWD",
    powertrain: "hybrid",
    colour: "Blue", colourOk: true,
    seating: null, pano: false,
    km: 30853, vin: null, stock: null,
    dealer: "GTA dealer", city: "Toronto area, ON", distanceKm: 18,
    msrp: 46000, price: 43900, fees: 1540, incentives: 0,
    financeApr: 5.69, financeMonths: 60,
    leaseApr: 6.89, leaseMonths: 24, residualPct: 60, kmPerYear: 24000,
    residualSource: "estimated", carfax: null,
    url: null, evidence: [], verified: "listing",
    notes: [
      "Lowest all-in cost of anything in the set that still meets the colour rule. 18 km away.",
      "30,853 km on a 2025 — roughly one year of average use. Balance of Toyota 3yr/60,000km basic warranty is thin; powertrain 5yr/100,000km still has room.",
      "RAV4 holds value better than almost anything in the segment, which cuts both ways: you pay for that on the way in.",
      "Carfax MANDATORY before this moves up the list."
    ]
  },
  {
   ...
   * OMVIC fee only (included in their price); HST + licensing are added by our math. */
  {
    ...
    powertrain: "gas",
    colour: "Silver or Blue (filtered)", colourOk: true,
    seating: null, pano: false,
    km: 19041, vin: null, stock: null,
    ...
    residualSource: "estimated", carfax: null,
    url: "https://www.clutch.ca/cars/toyota/silver",
    evidence: [], verified: "listing",
    notes: [
